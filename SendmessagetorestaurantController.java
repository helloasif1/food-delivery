 ...
 * @author USER
 */
public class SendmessagetorestaurantController implements Initializable {
    ...
    @FXML
    private void sendmessagetorestaurant(ActionEvent event) {
             File f = null;
        FileWriter fw = null;
        FileChooser fc = null;
        ...
        try {
            ...
            f = new File("messagetorestaurant.txt");      
    ...
    private void Backbuttononclick(ActionEvent event) throws IOException {
         Parent scene2;
        scene2 = FXMLLoader.load(getClass().getResource("CustomerScene1.fxml"));
    ...
    private void viewmessagefromrestaurant(ActionEvent event) {
          textarea.clear();
        File f = null;
        //FileReader fw = null;
        Scanner sc; String str; String[] tokens;
        try {
            f = new File("restocustomer.txt");
            sc = new Scanner(f);
            if(f.exists()){
                textarea.appendText("Messages from restaurant\n");
    ...
    @FXML
    private void viewmessagefromrestaurants(ActionEvent event) {
           textarea.clear();
        File f = null;
        //FileReader fw = null;
        Scanner sc; String str; String[] tokens;
