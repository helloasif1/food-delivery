 ...
 * @author USER
 */
public class SendoffertoresController implements Initializable {
    ...
    private void sendoffer(ActionEvent event) {
        ...
        a.setContentText("New market offer has been sent successfully ");
        a.showAndWait();
    }
    ...
    private void Backbuttononclick(ActionEvent event) throws IOException {
         Parent scene2;
        scene2 = FXMLLoader.load(getClass().getResource("administrator.fxml"));
